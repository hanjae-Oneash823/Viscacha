...
The downloaded file URLs, SHA-256 hashes, and local paths are recorded in `expanded_inputs_manifest.json`.
...
- Aggregate machine-readable summary: `expanded_analysis/expanded_summary.json`
- All replicate-level values: `expanded_analysis/replicate_results.csv`
- Per-row disposition: `expanded_analysis/candidate_status.csv`
- Quantitative figures: `standalone_figures/expanded_campaign/`
- Per-run PDBQT poses and JSON: each candidate's `runs/` directory
- BACE1 model-quality report: `BACE1_verubecestat/prepared/alternate_model_quality.json`
- Interface geometry report: `interface_model_metadata.json`
