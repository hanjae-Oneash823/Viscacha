...
> **Update:** The expanded all-candidate campaign is reported in `../KEY_FINDINGS.md`. The original CaV1.3 control below used the wrong 8E59 residue (`3PE`, a lipid) because of a ligand-code error. The corrected amiodarone ligand is `BBI A2201`; the corrected results in this document supersede the original CaV1.3 values.
...
![FYN redocking reproducibility](../../figures/preliminary/FYN_redocking_RMSD_replicates.png)
...
![FYN crystal and docked pose](../../figures/preliminary/3D/FYN_pocket_pose_overlay.png)
...
![FYN domain architecture](../../figures/preliminary/FYN_domain_architecture.png)
...
![KIT score reproducibility](../../figures/preliminary/KIT_masitinib_score_replicates.png)
...
![KIT docked masitinib](../../figures/preliminary/3D/KIT_pocket_docked_masitinib.png)

## 4. No KIT-223 docking score should be reported yet

![KIT structural coverage](../../figures/preliminary/KIT_1T46_structure_coverage.png)
