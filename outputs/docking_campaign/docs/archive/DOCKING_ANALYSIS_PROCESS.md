...
> **Update:** This historical preliminary report is superseded by `../ANALYSIS_PROCESS.md` for the all-candidate campaign. Its CaV1.3 section has been corrected because the original staging used `3PE`, a lipid, rather than amiodarone (`BBI`).
...
- `../../systems/FYN_saracatinib/prepared/fyn_chain_A.pdbqt`
- `../../systems/FYN_saracatinib/prepared/saracatinib_H8H_A601.pdbqt`
...
All poses from all completed runs were combined into `../../systems/FYN_saracatinib/analysis/all_poses.csv`. The top-scoring pose from each run was then used to calculate:
...
The machine-readable summary is `../../systems/FYN_saracatinib/analysis/summary.json`.
...
- `../../systems/KIT_masitinib/analysis/masitinib_1T46_replicates.csv`
- `../../systems/KIT_masitinib/analysis/masitinib_1T46_summary.json`
