...
Simpler than the layer2 APIClient — no per-request MD5 caching, just named
cache files per caller. Callers pass a cache_path; if the file exists it is
...
def _request(
    ...
    *,
    ...
    session.headers["User-Agent"] = "ASSISTANT_SURVEYOR/1.0 (VISCACHA pipeline)"
